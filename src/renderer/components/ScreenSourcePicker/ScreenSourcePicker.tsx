	...
	return (
		<div className="screen-source-picker">
						...
						{windows.map(source => (
							...
							>
								...
								<div className="screen-source-picker__window-info">
									{source.appIcon && <img src={source.appIcon} alt="" className="screen-source-picker__app-icon" />}
									<span className="screen-source-picker__name">{source.name}</span>
								</div>
							</button>
						))}
			...
			<div className="screen-source-picker__actions">
				<button className="screen-source-picker__refresh" onClick={loadSources}>
				...
				<button className="screen-source-picker__confirm" onClick={handleConfirm} disabled={!selectedId}>
